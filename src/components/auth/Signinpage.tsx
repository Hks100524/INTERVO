...
export default function LoginForm({
  ...
  return (
    <div className="w-full">
        ...
        >
          <div className="space-y-2">
            <div className="flex items-center justify-between gap-3">
              ...
              <span className="rounded-full border border-zinc-200 px-2.5 py-0.5 text-[13px] text-zinc-500">
                Last used
              </span>
            </div>
      ...
      <div className="mt-6 border-t border-zinc-200 px-6 py-4 text-center sm:px-10">
